...
//		linearParams.height = height; 
	...
	public void InitViewPager() {
		...
		BaoxiuguanliFragment daifenpeiFragment = new BaoxiuguanliFragment();
		Bundle bundle = new Bundle();
		bundle.putInt("status", 0);
		daifenpeiFragment.setArguments(bundle);

		BaoxiuguanliFragment daiweixiuFragment = new BaoxiuguanliFragment();
		Bundle bundle1 = new Bundle();
		bundle1.putInt("status", 1);
		daiweixiuFragment.setArguments(bundle1);

		BaoxiuguanliFragment yijiedanFrament = new BaoxiuguanliFragment();
		Bundle bundle2 = new Bundle();
		bundle2.putInt("status", 2);
		yijiedanFrament.setArguments(bundle2);
		
		BaoxiuguanliFragment weixiuzhongFragment = new BaoxiuguanliFragment();
		Bundle bundle3 = new Bundle();
		bundle3.putInt("status", 3);
		weixiuzhongFragment.setArguments(bundle3);

		BaoxiuguanliFragment yiwanchengFragment = new BaoxiuguanliFragment();
		Bundle bundle4 = new Bundle();
		bundle4.putInt("status", 4);
		yiwanchengFragment.setArguments(bundle4);		

		fragmentList.add(daifenpeiFragment);
...
//			int i = currIndex + 1;
			switch (arg0) {
			case 0:
				 view1.setTextColor(getResources().getColor(R.color.theme_color));
				 view2.setTextColor(getResources().getColor(R.color.gray5));
				 view3.setTextColor(getResources().getColor(R.color.gray5));
				 view4.setTextColor(getResources().getColor(R.color.gray5));
				 view5.setTextColor(getResources().getColor(R.color.gray5));
				break;
			case 1:
				 view1.setTextColor(getResources().getColor(R.color.gray5));
