...
public class SmartCurainListAdapter extends BaseAdapter {
	...
	public SmartCurainListAdapter(Handler handler, Context mContext) {
		this.handler = handler;
	...
	public SmartCurainListAdapter(Context mContext, ArrayList<CurtainInfo> mList) {
		this.mContext = mContext;
		this.mList = mList;
	}
	...
	//MAC地址
	public SmartCurainListAdapter setDate(String mac){
	...
	public SmartCurainListAdapter updateList(CurtainInfo curtainInfo){
		if(curtainInfo!=null){
	...
	public SmartCurainListAdapter deleteDate(int id){
