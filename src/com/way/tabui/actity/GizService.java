	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case UPDATE_UI:
				...
				gatestua = (Boolean) deviceStatu.get(KEY_Gate);
				...
				bodystua = (Boolean) deviceStatu.get(KEY_Body);
				...
				spf.edit()
						.putInt("COLOR",
								Integer.parseInt(deviceStatu.get(
										KEY_LIGHT_COLOR).toString())).commit();
				isred = (Boolean) deviceStatu.get(KEY_RED_SWITCH);
				isInfrared = (Boolean) deviceStatu.get(KEY_INFRARED);
				blue = deviceStatu.get(KEY_LIGHT_BLUE).toString();
				green = deviceStatu.get(KEY_LIGHT_GREEN).toString();
				red = deviceStatu.get(KEY_LIGHT_RED).toString();
				speed = deviceStatu.get(KEY_SPEED).toString();
				sendbcmes();
				break;
			case RESP:
